...
export default function SearchPage() {
  ...
  const searchResults = data.filter((article) => {
    ...
    const descriptionMatch = article.description.toLowerCase().includes(decodedQuery);
    ...
    <div ref={sectionRef} className="mx-auto px-4 md:px-8 py-16">
      ...
      <div className="mb-16 text-center">
        ...
        <p className="text-gray-600">
          {searchResults.length} {searchResults.length === 1 ? 'article' : 'articles'} found for &quot;{decodedQuery}&quot;
        </p>
      </div>
