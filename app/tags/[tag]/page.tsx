  ...
  if (filteredArticles.length === 0) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center">
        ...
        <Link href="/tags" className="mt-4 px-6 py-2 bg-black text-white hover:bg-gray-800 transition duration-200">
          Back to all tags
        </Link>
      </div>
    );
    ...
    <div ref={sectionRef} className="mx-auto px-4 md:px-8 py-16">
      ...
      <div className="mb-16 text-center">
        ...
        <p className="text-gray-600">
          {filteredArticles.length} {filteredArticles.length === 1 ? 'article' : 'articles'} tagged with &quot;{tag}&quot;
        </p>
      </div>
